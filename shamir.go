...
func div(a, b uint8) uint8 {
	...
	// Ensure we return zero if an is zero but aren't subject to timing attacks
...
// ShamirSplit takes an arbitrarily long secret and generates a `parts`
...
func ShamirSplit(secret []byte, parts, threshold int) ([][]byte, error) {
	...
	mRand := mathrand.New(mathrand.NewSource(time.Now().UnixNano()))
...
// ShamirCombine is used to reverse a Split and reconstruct a secret
